...
def train_lasso_model_cv(args):
    ...
    logger.info(f"Config: label={args.label_column}, threshold={args.threshold} ({args.threshold_direction}), "
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LASSO on 16 ECG parameters, 5-fold CV")
    ...
    args.checkpoint_dir = os.path.join(
        args.checkpoint_dir,
        f"{args.output_prefix}{args.label_column}_{args.threshold_direction}{args.threshold}"
        f"_cv{args.n_folds}_{dt_string}",
    )
